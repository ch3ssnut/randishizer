 ...
 */
final class Version20220621094944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE users_ingredient_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE users_ingredient (id INT NOT NULL, owner_id INT NOT NULL, ingredient VARCHAR(50) NOT NULL, unit VARCHAR(15) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_BCC4D7E47E3C61F9 ON users_ingredient (owner_id)');
        ...
        $this->addSql('ALTER TABLE users_ingredient ADD CONSTRAINT FK_BCC4D7E47E3C61F9 FOREIGN KEY (owner_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users_ingredient DROP CONSTRAINT FK_BCC4D7E47E3C61F9');
        $this->addSql('DROP SEQUENCE dish_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE ingredient_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE "user_id_seq" CASCADE');
        $this->addSql('DROP SEQUENCE users_ingredient_id_seq CASCADE');
        $this->addSql('DROP TABLE dish');
        $this->addSql('DROP TABLE ingredient');
        $this->addSql('DROP TABLE "user"');
        $this->addSql('DROP TABLE users_ingredient');
    }
}
